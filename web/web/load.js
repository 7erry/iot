(function () {
    ...
    if (debugMode) {
        addScriptFile('./js/extjs/' + extjsVersion + '/ext-all-debug.js');
        addScriptFile('./js/extjs/' + extjsVersion + '/packages/charts/classic/charts-debug.js');
    } else {
        addScriptFile('./js/extjs/' + extjsVersion + '/ext-all.js');
        addScriptFile('./js/extjs/' + extjsVersion + '/packages/charts/classic/charts.js');
    }
    addScriptFile('./js/extjs/' + extjsVersion + '/classic/locale/locale-' + locale.languages[locale.language].code + '.js');

    addStyleFile('./js/extjs/' + extjsVersion + '/classic/theme-triton/resources/theme-triton-all.css');
    addScriptFile('./js/extjs/' + extjsVersion + '/classic/theme-triton/theme-triton.js');

    addStyleFile('./js/extjs/' + extjsVersion + '/packages/charts/classic/triton/resources/charts-all.css');

    addStyleFile('./js/ol/' + olVersion + '/ol.css');
    addScriptFile('./js/ol/' + olVersion + '/ol.js');

    if (debugMode) {
        addScriptFile('./js/proj4js/' + proj4jsVersion + '/proj4-src.js');
    } else {
        addScriptFile('./js/proj4js/' + proj4jsVersion + '/proj4.js');
    }
